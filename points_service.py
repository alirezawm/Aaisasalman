...
class PointsService:
    ...
    def __init__(self):
        self.default_points_per_100k = 500
        self.default_bonus_per_product = 50
        self.default_max_bonus = 1000
    ...
    try:
        ...
        if not default_rule:
            default_rule = PointsRule(
                ...
                points_per_100k_rials=500,
                bonus_points_per_product=50,
        ...
        default_levels = [
            {'level_name': 'Bronze', 'level_name_fa': 'Bronze', 'min_points': 0, 'max_points': 999, 'discount_percentage': 0},
            {'level_name': 'Silver', 'level_name_fa': 'Silver', 'min_points': 1000, 'max_points': 4999, 'discount_percentage': 5},
            {'level_name': 'Gold', 'level_name_fa': 'Gold', 'min_points': 5000, 'max_points': 9999, 'discount_percentage': 10},
            {'level_name': 'Platinum', 'level_name_fa': 'Platinum', 'min_points': 10000, 'max_points': None, 'discount_percentage': 15}
        ]
